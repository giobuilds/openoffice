...
#define DEFAULT_FILTERCACHE_VERSION                 6                                                                   /// these implementation of FilterCache support different version of TypeDetection.xml! This define the current set default one.
