...
.IF "$(COMEX)"=="14"
.IF "$(PACKMS)"!=""
	$(GNUCOPY) $(PACKMS)/vcruntime140.dll $(EXTENSIONDIR)
	$(GNUCOPY) $(PACKMS)/msvcp140.dll $(EXTENSIONDIR)
.ELSE
	$(GNUCOPY) $(SOLARBINDIR)/vcruntime140.dll $(EXTENSIONDIR)
	$(GNUCOPY) $(SOLARBINDIR)/msvcp140.dll $(EXTENSIONDIR)
.ENDIF
.ELSE
.IF "$(PACKMS)"!=""
