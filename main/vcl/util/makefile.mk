...
.IF "$(ENABLE_HARFBUZZ)" == "TRUE"
CDEFS+=-DENABLE_HARFBUZZ
.ENDIF
...
SHL1STDLIBS+= $(HARFBUZZ_LIBS)
.ELSE
SHL1STDLIBS+= $(SOLARVERSION)/$(INPATH)/lib$(UPDMINOREXT)/libharfbuzz.a
.ENDIF
.ENDIF
.ENDIF
...
.ELSE
.IF "$(COM)" == "GCC"
SHL1STDLIBS += -lharfbuzz
.ELSE
SHL1STDLIBS += harfbuzz.lib
.ENDIF
.ENDIF
.ENDIF
